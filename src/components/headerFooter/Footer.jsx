      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          >
            ...
            <motion.a
              href="https://www.linkedin.com/in/ranjan-gupta-641026204?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
              target="_blank"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          >
            ...
            <a href="https://www.linkedin.com/in/ranjan-gupta-641026204?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
              <span style={{ color: themeColors.primaryColor }}>Ranjan</span>
            </a>{" "}
