...
const FooterSocial = () => {
  ...
  const socials = [
    ...
    },
    {
      ...
      icon: FiLinkedin,
      label: "ranjan-gupta",
      url: "https://www.linkedin.com/in/ranjan-gupta-641026204?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
      color: "#0e76a8",
    },
    {
      id: "github",
